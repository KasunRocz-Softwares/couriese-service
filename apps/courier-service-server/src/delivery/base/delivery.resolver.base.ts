...
import { CourierAgent } from "../../courierAgent/base/CourierAgent";
...
export class DeliveryResolverBase {
  ...
  async createDelivery(
    ...
    return await this.service.createDelivery({
      ...
      data: {
        ...
        courierAgent: args.data.courierAgent
          ? {
              connect: args.data.courierAgent,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => CourierAgent, {
    nullable: true,
    name: "courierAgent",
  })
  async getCourierAgent(
    @graphql.Parent() parent: Delivery
  ): Promise<CourierAgent | null> {
    const result = await this.service.getCourierAgent(parent.id);
