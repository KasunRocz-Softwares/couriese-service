...
@InputType()
class DeliveryCreateNestedManyWithoutCourierAgentsInput {
...
export { DeliveryCreateNestedManyWithoutCourierAgentsInput as DeliveryCreateNestedManyWithoutCourierAgentsInput };
